...
//       err.code === AuthErrors.TOKEN[expectErrorCode]?.code
//     ) {
//       console.log(`✅ ${label} → threw ${err.code}`);
//     } else {
//       console.error(
//         `❌ ${label} → threw ${err.code}, expected ${AuthErrors.TOKEN[expectErrorCode]?.code}`
//       );
//     }
//   }
// }
...
//   [
//     "missing sub",
//     { iat: validPayload.iat, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "sub is null",
//     { sub: null, iat: validPayload.iat, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "sub is number",
//     { sub: 123, iat: validPayload.iat, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "sub is empty string",
//     { sub: "", iat: validPayload.iat, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "sub is whitespace",
...
//   [
//     "iat is string",
//     { sub: "u1", iat: "123", exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "iat is null",
//     { sub: "u1", iat: null, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "iat is NaN",
//     { sub: "u1", iat: NaN, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "iat is Infinity",
//     { sub: "u1", iat: Infinity, exp: validPayload.exp },
//     "INVALID_PAYLOAD",
//   ],
...
//   [
//     "exp is string",
//     { sub: "u1", iat: validPayload.iat, exp: "999999" },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "exp is null",
//     { sub: "u1", iat: validPayload.iat, exp: null },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "exp is NaN",
//     { sub: "u1", iat: validPayload.iat, exp: NaN },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "exp is Infinity",
//     { sub: "u1", iat: validPayload.iat, exp: Infinity },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "exp is negative",
//     { sub: "u1", iat: validPayload.iat, exp: -100 },
//     "INVALID_PAYLOAD",
//   ],
//   [
//     "exp is zero",
//     { sub: "u1", iat: validPayload.iat, exp: 0 },
//     "INVALID_PAYLOAD",
//   ],
// ];
